...
import { NormalLikeSvgStyled } from "./normalLikeSvgStyled";

const NormalLikeSvg = () => {
  return (
    <NormalLikeSvgStyled id="icon-normal" viewBox="0 0 32 32" width="18" height="18">
      <path
        fill="none"
        stroke="#fff"
